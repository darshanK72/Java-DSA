 ...
 * Problem Statement:
 * 
 *     Given a singly linked list, sort it using the merge sort algorithm.
 * 
 * Input:
...
public class j03MergSortLinkedList {
    ...
    public Node mergeSortList(Node head) {
        ...
        Node n1 = mergeSortList(head); // Recursively sort the left half
        Node n2 = mergeSortList(mid); // Recursively sort the right half
