...
public class j06NonOverlappingIntervals {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Output: " + eraseOverlapIntervals(intervals1));
        ...
        System.out.println("Output: " + eraseOverlapIntervals(intervals2));
        ...
        System.out.println("Output: " + eraseOverlapIntervals(intervals3));
        ...
        System.out.println("Output: " + eraseOverlapIntervals(intervals4));
        System.out.println("Expected: 0");
        ...
        System.out.println("Output: " + eraseOverlapIntervals(intervals5));
        System.out.println("Expected: 0");
    }
}
