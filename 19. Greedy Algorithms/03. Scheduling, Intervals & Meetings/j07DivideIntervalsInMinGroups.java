...
public class j07DivideIntervalsInMinGroups {
    ...
    public static void main(String[] args) {
        j07DivideIntervalsInMinGroups solution = new j07DivideIntervalsInMinGroups();
        ...
        System.out.println("Output (ArrayList): " + solution.minGroups(intervals1));
        System.out.println("Output (PriorityQueue): " + solution.minGroupsPriorityQueue(intervals1));
        ...
        System.out.println("Output (ArrayList): " + solution.minGroups(intervals2));
        System.out.println("Output (PriorityQueue): " + solution.minGroupsPriorityQueue(intervals2));
        ...
        System.out.println("Output (ArrayList): " + solution.minGroups(intervals3));
        System.out.println("Output (PriorityQueue): " + solution.minGroupsPriorityQueue(intervals3));
        System.out.println("Expected: 3");
        ...
        System.out.println("Output (ArrayList): " + solution.minGroups(intervals4));
        System.out.println("Output (PriorityQueue): " + solution.minGroupsPriorityQueue(intervals4));
        ...
        System.out.println("Output (ArrayList): " + solution.minGroups(intervals5));
        System.out.println("Output (PriorityQueue): " + solution.minGroupsPriorityQueue(intervals5));
        System.out.println("Expected: 1");
    }
}
